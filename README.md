...
`TODO: Concatenate the strings "Who is the imposter?", "Where is the imposter?", "Why is the imposter?" using '..' `<br><br>
...
`TODO: Print the string "[name_1] had a little [animal] while [name_2] had [number] cows!" using concatenation and variables.`
